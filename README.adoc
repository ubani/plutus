...
Plutus Core is the programming language embedded into Cardano itself for the use of scripts.
...
* The interface to Plutus Core used by the Cardano ledger.

[IMPORTANT]
====
This repository used to contain the code for the Plutus Application Framework and Marlowe also.
We have since split it into three repositories.
You can find the others at ??? and ??.
====

[IMPORTANT]
====
The rest of this README is focussed on people who want to develop or contribute to Plutus.

For people who want to *use* the Plutus, please consult the <<user-documentation>>.
====
